(define (domain appn)
 ...
 (:action breaker-close-unexplained0
  ...
  :effect (and (breaker-state-is-closed breaker_x1_x2) (observed ?o0) (not (breaker-state-is-open breaker_x1_x2)) (not (pending ?o0)) (increase (total-cost) 1))
 )
 ...
 (:action breaker-reclose0
  ...
  :effect (and (breaker-state-is-closed breaker_x1_x2) (breaker-auto-reopen-wait breaker_x1_x2 ?o0) (observed ?o0) (not (breaker-state-is-open breaker_x1_x2)) (not (pending ?o0)))
 )
 ...
 (:action breaker-close-on-command0
  ...
  :effect (and (breaker-state-is-closed breaker_x1_x2) (observed ?o0) (not-breaker-auto-reclose-lockout breaker_x1_x2) (not (breaker-state-is-open breaker_x1_x2)) (not (breaker-state-is-unknown breaker_x1_x2)) (not (breaker-auto-reclose-lockout breaker_x1_x2)) (not (pending ?o0)))
 )
 ...
 (:action advance-to-obs0
  :parameters ()
  :precondition (and (future obs628))
  :effect (and (pending obs628) (not (future obs628)))
 )
 (:action advance-to-obs1
  :parameters ()
  :precondition (and (future obs629) (observed obs628))
  :effect (and (pending obs629) (not (future obs629)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs628)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs628)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs628)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs628)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs628)))
 )
 (:action advance-to-obs2
  :parameters ()
  :precondition (and (future obs630) (observed obs629))
  :effect (and (pending obs630) (not (future obs630)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs629)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs629)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs629)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs629)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs629)) (not (capacitor-switched-in obs628)) (not (capacitor-switched-in obs629)) (not (capacitor-switched-out obs628)) (not (capacitor-switched-out obs629)))
 )
 (:action advance-to-obs3
  :parameters ()
  :precondition (and (future obs631) (observed obs630))
  :effect (and (pending obs631) (not (future obs631)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs630)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs630)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs630)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs630)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs630)))
 )
 (:action advance-to-obs4
  :parameters ()
  :precondition (and (future obs632) (observed obs631))
  :effect (and (pending obs632) (not (future obs632)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs631)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs631)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs631)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs631)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs631)) (not (capacitor-switched-in obs630)) (not (capacitor-switched-in obs631)) (not (capacitor-switched-out obs630)) (not (capacitor-switched-out obs631)))
 )
 (:action advance-to-obs5
  :parameters ()
  :precondition (and (future obs633) (observed obs632))
  :effect (and (pending obs633) (not (future obs633)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs632)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs632)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs632)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs632)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs632)))
 )
 (:action advance-to-obs6
  :parameters ()
  :precondition (and (future obs634) (observed obs632))
  :effect (and (pending obs634) (not (future obs634)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs632)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs632)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs632)) (not (breaker-auto-reopen-wait breaker_x7_x8 obs632)) (not (breaker-auto-reopen-wait breaker_x9_x10 obs632)))
 )
)
