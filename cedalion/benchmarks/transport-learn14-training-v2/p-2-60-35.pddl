; Transport two-cities-sequential-60nodes-1000size-4degree-100mindistance-4trucks-35packages-1012seed

(define (problem transport-two-cities-sequential-60nodes-1000size-4degree-100mindistance-4trucks-35packages-1012seed)
 (:domain transport)
 (:objects
 ...
 (:goal (and
  ...
  (at package-33 city-2-loc-29)
  (at package-34 city-2-loc-25)
  (at package-35 city-2-loc-36)
 ))
