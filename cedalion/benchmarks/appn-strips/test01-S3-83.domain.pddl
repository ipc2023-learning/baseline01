(define (domain appn)
 ...
 (:action advance-to-obs0
  :parameters ()
  :precondition (and (future obs1570))
  :effect (and (pending obs1570) (not (future obs1570)))
 )
 (:action advance-to-obs1
  :parameters ()
  :precondition (and (future obs1571) (observed obs1570))
  :effect (and (pending obs1571) (not (future obs1571)))
 )
 (:action advance-to-obs2
  :parameters ()
  :precondition (and (future obs1572) (observed obs1571))
  :effect (and (pending obs1572) (not (future obs1572)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs1570)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs1571)))
 )
 (:action advance-to-obs3
  :parameters ()
  :precondition (and (future obs1573) (observed obs1572))
  :effect (and (pending obs1573) (not (future obs1573)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs1572)) (not (capacitor-switched-in obs1570)) (not (capacitor-switched-in obs1571)) (not (capacitor-switched-out obs1570)) (not (capacitor-switched-out obs1571)))
 )
 (:action advance-to-obs4
  :parameters ()
  :precondition (and (future obs1574) (observed obs1573))
  :effect (and (pending obs1574) (not (future obs1574)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs1573)) (not (capacitor-switched-in obs1572)) (not (capacitor-switched-out obs1572)))
 )
)
