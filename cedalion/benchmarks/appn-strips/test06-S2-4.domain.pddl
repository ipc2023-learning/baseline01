(define (domain appn)
 ...
 (:action breaker-close-unexplained1
  ...
  :effect (and (breaker-state-is-closed breaker_x3_x4) (observed ?o0) (line-iso-state-may-have-changed line_x7_x8 ?o0) (not (breaker-state-is-open breaker_x3_x4)) (not (pending ?o0)) (increase (total-cost) 1))
 )
 ...
 (:action breaker-reclose1
  ...
  :effect (and (breaker-state-is-closed breaker_x3_x4) (breaker-auto-reopen-wait breaker_x3_x4 ?o0) (observed ?o0) (line-iso-state-may-have-changed line_x7_x8 ?o0) (not (breaker-state-is-open breaker_x3_x4)) (not (pending ?o0)))
 )
 ...
 (:action breaker-close-on-command1
  ...
  :effect (and (breaker-state-is-closed breaker_x3_x4) (observed ?o0) (line-iso-state-may-have-changed line_x7_x8 ?o0) (not-breaker-auto-reclose-lockout breaker_x3_x4) (not (breaker-state-is-open breaker_x3_x4)) (not (breaker-state-is-unknown breaker_x3_x4)) (not (breaker-auto-reclose-lockout breaker_x3_x4)) (not (pending ?o0)))
 )
 ...
 (:action advance-to-obs1
  :parameters ()
  :precondition (and (future obs61) (observed obs60) (not-line-iso-trip-in-progress line_x7_x8 obs60) (not-line-iso-trip-in-progress line_x9_x10 obs60))
  :effect (and (pending obs61) (not (future obs61)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs60)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs60)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs60)) (not (breaker-auto-reopen-wait breaker_x11_x12 obs60)) (not (breaker-auto-reopen-wait breaker_x13_x14 obs60)) (not (line-iso-state-may-have-changed line_x7_x8 obs60)) (not (line-iso-state-may-have-changed line_x9_x10 obs60)) (not (line-iso-state-changed line_x7_x8 obs60)) (not (line-iso-state-changed line_x9_x10 obs60)) (not (capacitor-switched-in obs60)) (not (capacitor-switched-out obs60)))
 )
 (:action advance-to-obs2
  :parameters ()
  :precondition (and (future obs62) (observed obs61) (not-line-iso-trip-in-progress line_x7_x8 obs61) (not-line-iso-trip-in-progress line_x9_x10 obs61))
  :effect (and (pending obs62) (not (future obs62)) (not (breaker-auto-reclose-wait breaker_x1_x2 obs60)) (not (breaker-auto-reclose-wait breaker_x3_x4 obs60)) (not (breaker-auto-reclose-wait breaker_x5_x6 obs60)) (not (breaker-auto-reclose-wait breaker_x11_x12 obs60)) (not (breaker-auto-reclose-wait breaker_x13_x14 obs60)) (not (breaker-commanded-open breaker_x1_x2 obs60)) (not (breaker-commanded-open breaker_x3_x4 obs60)) (not (breaker-commanded-open breaker_x5_x6 obs60)) (not (breaker-commanded-open breaker_x11_x12 obs60)) (not (breaker-commanded-open breaker_x13_x14 obs60)) (not (breaker-commanded-closed breaker_x1_x2 obs60)) (not (breaker-commanded-closed breaker_x3_x4 obs60)) (not (breaker-commanded-closed breaker_x5_x6 obs60)) (not (breaker-commanded-closed breaker_x11_x12 obs60)) (not (breaker-commanded-closed breaker_x13_x14 obs60)) (not (breaker-commanded-ar-auto breaker_x1_x2 obs60)) (not (breaker-commanded-ar-auto breaker_x3_x4 obs60)) (not (breaker-commanded-ar-auto breaker_x5_x6 obs60)) (not (breaker-commanded-ar-auto breaker_x11_x12 obs60)) (not (breaker-commanded-ar-auto breaker_x13_x14 obs60)) (not (breaker-commanded-ar-non-auto breaker_x1_x2 obs60)) (not (breaker-commanded-ar-non-auto breaker_x3_x4 obs60)) (not (breaker-commanded-ar-non-auto breaker_x5_x6 obs60)) (not (breaker-commanded-ar-non-auto breaker_x11_x12 obs60)) (not (breaker-commanded-ar-non-auto breaker_x13_x14 obs60)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs61)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs61)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs61)) (not (breaker-auto-reopen-wait breaker_x11_x12 obs61)) (not (breaker-auto-reopen-wait breaker_x13_x14 obs61)) (not (line-iso-state-may-have-changed line_x7_x8 obs61)) (not (line-iso-state-may-have-changed line_x9_x10 obs61)) (not (line-iso-state-changed line_x7_x8 obs61)) (not (line-iso-state-changed line_x9_x10 obs61)) (not (capacitor-switched-in obs61)) (not (capacitor-switched-out obs61)))
 )
 (:action advance-to-obs3
  :parameters ()
  :precondition (and (future obs63) (observed obs62) (not-line-iso-trip-in-progress line_x7_x8 obs62) (not-line-iso-trip-in-progress line_x9_x10 obs62))
  :effect (and (pending obs63) (not (future obs63)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs62)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs62)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs62)) (not (breaker-auto-reopen-wait breaker_x11_x12 obs62)) (not (breaker-auto-reopen-wait breaker_x13_x14 obs62)))
 )
 (:action advance-to-obs4
  :parameters ()
  :precondition (and (future obs64) (observed obs63) (not-line-iso-trip-in-progress line_x7_x8 obs63) (not-line-iso-trip-in-progress line_x9_x10 obs63))
  :effect (and (pending obs64) (not (future obs64)) (not (breaker-auto-reclose-wait breaker_x1_x2 obs61)) (not (breaker-auto-reclose-wait breaker_x3_x4 obs61)) (not (breaker-auto-reclose-wait breaker_x5_x6 obs61)) (not (breaker-auto-reclose-wait breaker_x11_x12 obs61)) (not (breaker-auto-reclose-wait breaker_x13_x14 obs61)) (not (breaker-commanded-open breaker_x1_x2 obs61)) (not (breaker-commanded-open breaker_x3_x4 obs61)) (not (breaker-commanded-open breaker_x5_x6 obs61)) (not (breaker-commanded-open breaker_x11_x12 obs61)) (not (breaker-commanded-open breaker_x13_x14 obs61)) (not (breaker-commanded-closed breaker_x1_x2 obs61)) (not (breaker-commanded-closed breaker_x3_x4 obs61)) (not (breaker-commanded-closed breaker_x5_x6 obs61)) (not (breaker-commanded-closed breaker_x11_x12 obs61)) (not (breaker-commanded-closed breaker_x13_x14 obs61)) (not (breaker-commanded-ar-auto breaker_x1_x2 obs61)) (not (breaker-commanded-ar-auto breaker_x3_x4 obs61)) (not (breaker-commanded-ar-auto breaker_x5_x6 obs61)) (not (breaker-commanded-ar-auto breaker_x11_x12 obs61)) (not (breaker-commanded-ar-auto breaker_x13_x14 obs61)) (not (breaker-commanded-ar-non-auto breaker_x1_x2 obs61)) (not (breaker-commanded-ar-non-auto breaker_x3_x4 obs61)) (not (breaker-commanded-ar-non-auto breaker_x5_x6 obs61)) (not (breaker-commanded-ar-non-auto breaker_x11_x12 obs61)) (not (breaker-commanded-ar-non-auto breaker_x13_x14 obs61)) (not (breaker-auto-reopen-wait breaker_x1_x2 obs63)) (not (breaker-auto-reopen-wait breaker_x3_x4 obs63)) (not (breaker-auto-reopen-wait breaker_x5_x6 obs63)) (not (breaker-auto-reopen-wait breaker_x11_x12 obs63)) (not (breaker-auto-reopen-wait breaker_x13_x14 obs63)) (not (line-iso-state-may-have-changed line_x7_x8 obs62)) (not (line-iso-state-may-have-changed line_x9_x10 obs62)) (not (line-iso-state-may-have-changed line_x7_x8 obs63)) (not (line-iso-state-may-have-changed line_x9_x10 obs63)) (not (line-iso-state-changed line_x7_x8 obs62)) (not (line-iso-state-changed line_x9_x10 obs62)) (not (line-iso-state-changed line_x7_x8 obs63)) (not (line-iso-state-changed line_x9_x10 obs63)) (not (capacitor-switched-in obs62)) (not (capacitor-switched-in obs63)) (not (capacitor-switched-out obs62)) (not (capacitor-switched-out obs63)))
 )
)
